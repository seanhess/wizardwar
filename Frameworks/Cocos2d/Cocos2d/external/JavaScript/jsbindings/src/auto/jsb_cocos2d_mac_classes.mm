...
void JSB_CCDirector_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("convertEventToGL", JSB_CCDirector_convertEventToGL_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
...
// 'ctor' method. Needed for subclassing native objects in JS
JSBool JSB_CCDirectorMac_ctor(JSContext *cx, uint32_t argc, jsval *vp) {

	JSObject* obj = (JSObject *)JS_THIS_OBJECT(cx, vp);
	JSB_PRECONDITION2( !JSB_get_proxy_for_jsobject(obj), cx, JS_FALSE, "Object already initialzied. error" );

	JSB_CCDirectorMac *proxy = [[JSB_CCDirectorMac alloc] initWithJSObject:obj class:[CCDirectorMac class]];
	[[proxy class] swizzleMethods];
...
void JSB_CCDirectorMac_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		JS_FN("convertToLogicalCoordinates", JSB_CCDirectorMac_convertToLogicalCoordinates_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getIsFullScreen", JSB_CCDirectorMac_isFullScreen, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getOriginalWinSize", JSB_CCDirectorMac_originalWinSize, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getResizeMode", JSB_CCDirectorMac_resizeMode, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setFullScreen", JSB_CCDirectorMac_setFullScreen_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setOriginalWinSize", JSB_CCDirectorMac_setOriginalWinSize_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setResizeMode", JSB_CCDirectorMac_setResizeMode_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ctor", JSB_CCDirectorMac_ctor, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FS_END
	};
	static JSFunctionSpec st_funcs[] = {
		JS_FN("sharedDirector", JSB_CCDirectorMac_sharedDirector_static, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FS_END
	};
...
void JSB_CCLayer_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		JS_FN("getGesturePriority", JSB_CCLayer_gesturePriority, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("isGestureEnabled", JSB_CCLayer_isGestureEnabled, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("isKeyboardEnabled", JSB_CCLayer_isKeyboardEnabled, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("isMouseEnabled", JSB_CCLayer_isMouseEnabled, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("isTouchEnabled", JSB_CCLayer_isTouchEnabled, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getKeyboardPriority", JSB_CCLayer_keyboardPriority, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getMousePriority", JSB_CCLayer_mousePriority, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setGestureEnabled", JSB_CCLayer_setGestureEnabled_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setGesturePriority", JSB_CCLayer_setGesturePriority_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setKeyboardEnabled", JSB_CCLayer_setKeyboardEnabled_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setKeyboardPriority", JSB_CCLayer_setKeyboardPriority_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setMouseEnabled", JSB_CCLayer_setMouseEnabled_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setMousePriority", JSB_CCLayer_setMousePriority_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		...
		JS_FN("ccMouseEntered", JSB_CCLayer_ccMouseEntered_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ccMouseExited", JSB_CCLayer_ccMouseExited_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ccMouseMoved", JSB_CCLayer_ccMouseMoved_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ccOtherMouseDown", JSB_CCLayer_ccOtherMouseDown_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ccOtherMouseDragged", JSB_CCLayer_ccOtherMouseDragged_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ccOtherMouseUp", JSB_CCLayer_ccOtherMouseUp_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ccRightMouseDown", JSB_CCLayer_ccRightMouseDown_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ccRightMouseDragged", JSB_CCLayer_ccRightMouseDragged_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ccRightMouseUp", JSB_CCLayer_ccRightMouseUp_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ccScrollWheel", JSB_CCLayer_ccScrollWheel_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ccTouchesBeganWithEvent", JSB_CCLayer_ccTouchesBeganWithEvent_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ccTouchesCancelledWithEvent", JSB_CCLayer_ccTouchesCancelledWithEvent_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ccTouchesEndedWithEvent", JSB_CCLayer_ccTouchesEndedWithEvent_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ccTouchesMovedWithEvent", JSB_CCLayer_ccTouchesMovedWithEvent_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("onMouseUp", JSB_do_nothing, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("onMouseDown", JSB_do_nothing, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("onMouseDragged", JSB_do_nothing, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("onKeyFlagsChanged", JSB_do_nothing, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("onKeyUp", JSB_do_nothing, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("onKeyDown", JSB_do_nothing, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
...
-(BOOL) ccMouseUp:(NSEvent*)event 
{
	...
	if (_jsObj) {
		...
		if (found == JS_TRUE) {
			...
			unsigned argc=1;
			jsval argv[1];
			argv[0] = JSB_jsval_from_NSObject(cx, event);
