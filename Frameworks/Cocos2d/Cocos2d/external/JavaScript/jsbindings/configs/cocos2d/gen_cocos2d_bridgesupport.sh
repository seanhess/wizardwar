...
# cocos2d
gen_bridge_metadata -F complete --no-64-bit -c '-DCC_ENABLE_CHIPMUNK_INTEGRATION=1 -ISupport -IPlatforms -I. -I../external/Chipmunk/include/chipmunk/. -I../external/Chipmunk/include/chipmunk/constraints/.' *.h Support/*.h Platforms/*.h -o ../external/JavaScript/jsbindings/configs/cocos2d/cocos2d.bridgesupport

# cocos2d-mac
gen_bridge_metadata -F complete --64-bit -c '-D__CC_PLATFORM_MAC -ISupport -IPlatforms -IPlatforms/Mac -I.' *.h Platforms/*.h Platforms/Mac/*.h -o ../external/JavaScript/jsbindings/configs/cocos2d/cocos2d-mac.bridgesupport 
