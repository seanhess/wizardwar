...
#include "jsb_chipmunk_functions.h"
...
JSBool JSB_cpConstraint_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JSB_PRECONDITION2(NO, cx, JS_TRUE, "No constructor");
...
JSBool JSB_cpConstraint_getSpace(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	JS_SET_RVAL(cx, vp, JSB_jsval_from_c_class( cx, ret_val, JSB_cpSpace_object, JSB_cpSpace_class, "cpSpace" ));
...
JSBool JSB_cpGrooveJoint_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	ok &= JSB_jsval_to_c_class( cx, *argvp++, (void**)&arg0, NULL );
	ok &= JSB_jsval_to_c_class( cx, *argvp++, (void**)&arg1, NULL );
	ok &= JSB_jsval_to_cpVect( cx, *argvp++, (cpVect*) &arg2 );
	ok &= JSB_jsval_to_cpVect( cx, *argvp++, (cpVect*) &arg3 );
	ok &= JSB_jsval_to_cpVect( cx, *argvp++, (cpVect*) &arg4 );
	JSB_PRECONDITION2(ok, cx, JS_FALSE, "Error processing arguments");
...
JSBool JSB_cpGrooveJoint_getAnchr2(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	JS_SET_RVAL(cx, vp, JSB_jsval_from_cpVect( cx, (cpVect)ret_val ));
...
JSBool JSB_cpGrooveJoint_setAnchr2(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	ok &= JSB_jsval_to_cpVect( cx, *argvp++, (cpVect*) &arg1 );
	JSB_PRECONDITION2(ok, cx, JS_FALSE, "Error processing arguments");
...
JSBool JSB_cpSpace_pointQueryFirst(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	ok &= JSB_jsval_to_long( cx, *argvp++, (long*) &arg3 );
	JSB_PRECONDITION2(ok, cx, JS_FALSE, "Error processing arguments");
	cpShape* ret_val;

	ret_val = cpSpacePointQueryFirst((cpSpace*)arg0 , (cpVect)arg1 , (cpLayers)arg2 , (cpGroup)arg3  );

	JS_SET_RVAL(cx, vp, JSB_jsval_from_c_class( cx, ret_val, JSB_cpShape_object, JSB_cpShape_class, "cpShape" ));
...
JSBool JSB_cpShape_cacheBB(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	JS_SET_RVAL(cx, vp, JSB_jsval_from_cpBB( cx, (cpBB)ret_val ));
...
JSBool JSB_cpShape_getCollisionType(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	JS_SET_RVAL(cx, vp, JSB_jsval_from_long( cx, (cpCollisionType)ret_val ));
...
JSBool JSB_cpShape_getGroup(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	JS_SET_RVAL(cx, vp, JSB_jsval_from_long( cx, (cpGroup)ret_val ));
...
JSBool JSB_cpShape_setCollisionType(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	ok &= JSB_jsval_to_long( cx, *argvp++, (long*) &arg1 );
	JSB_PRECONDITION2(ok, cx, JS_FALSE, "Error processing arguments");
