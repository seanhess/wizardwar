...
JSBool JSB_cpAreaForSegment(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	ok &= JSB_jsval_to_cpVect( cx, *argvp++, (cpVect*) &arg0 );
	ok &= JSB_jsval_to_cpVect( cx, *argvp++, (cpVect*) &arg1 );
...
JSBool JSB_cpBBArea(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	ok &= JSB_jsval_to_cpBB( cx, *argvp++, (cpBB*) &arg0 );
	JSB_PRECONDITION2(ok, cx, JS_FALSE, "Error processing arguments");
	cpFloat ret_val;
...
JSBool JSB_cpBBContainsBB(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	ok &= JSB_jsval_to_cpBB( cx, *argvp++, (cpBB*) &arg0 );
	ok &= JSB_jsval_to_cpBB( cx, *argvp++, (cpBB*) &arg1 );
	JSB_PRECONDITION2(ok, cx, JS_FALSE, "Error processing arguments");
	cpBool ret_val;
...
JSBool JSB_cpMessage(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	ok &= JSB_jsval_to_charptr( cx, *argvp++, &arg5 );
	JSB_PRECONDITION2(ok, cx, JS_FALSE, "Error processing arguments");
...
JSBool JSB_cpvstr(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	ret_val = cpvstr((cpVect)arg0  );

	JS_SET_RVAL(cx, vp, JSB_jsval_from_charptr( cx, ret_val ));
