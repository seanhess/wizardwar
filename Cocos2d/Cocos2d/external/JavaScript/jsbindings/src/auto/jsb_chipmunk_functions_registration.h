...
JS_DefineFunction(_cx, chipmunk, "message", JSB_cpMessage, 6, JSPROP_READONLY | JSPROP_PERMANENT | JSPROP_ENUMERATE );
...
JS_DefineFunction(_cx, chipmunk, "vstr", JSB_cpvstr, 1, JSPROP_READONLY | JSPROP_PERMANENT | JSPROP_ENUMERATE );
